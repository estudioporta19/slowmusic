    ...
    return (function() {
        ...
        1: [function(require, module, exports) {
            ...
            function findPeaks(data) {
                var peaks = [];
                var threshold = 0.8; // Mantido em 0.8 para maior sensibilidade
                var minThresold = 0.3;
                var minPeaks = 15;
                ...
                // Lógica de último recurso para encontrar picos se os primeiros limiares falharem
                if (peaks.length < minPeaks) {
                     threshold = 0.2; // Tenta um limiar ainda mais baixo
                     peaks = findPeaksAtThreshold(data, threshold);
                     if (peaks.length < minPeaks) {
                ...
                return function(intervalCounts) {
                    ...
                    intervalCounts.forEach(function(intervalCount) {
                        if (intervalCount.interval !== 0) {
                            ...
                            // --- NORMALIZAÇÃO REINTRODUZIDA AQUI (90-180 BPM) ---
