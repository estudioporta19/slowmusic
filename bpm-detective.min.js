    ...
    return (function() {
        ...
        1: [function(require, module, exports) {
            ...
            function findPeaks(data) {
                var peaks = [];
                var threshold = 0.8; // Ajustado para 0.8 para maior sensibilidade
                var minThresold = 0.3;
                var minPeaks = 15;
                ...
                // Opção extra para tentar um limiar mais baixo se não encontrar picos suficientes
            ...
            function findPeaksAtThreshold(data, threshold) {
                ...
                for (var i = 0, l = data.length; i < l; i += 1) {
                    if (data[i] > threshold) {
                        peaks.push(i);
                        i += 10000; // Avança para evitar picos muito próximos
                    }
                }
                ...
                return function(intervalCounts) {
                    ...
                    intervalCounts.forEach(function(intervalCount) {
                        if (intervalCount.interval !== 0) {
                            ...
                            // --- CÓDIGO DE NORMALIZAÇÃO REMOVIDO AQUI ---
                            // As linhas 'while (theoreticalTempo < X)' e 'while (theoreticalTempo > Y)' foram removidas.
                            // Agora, o BPM será o valor detetado, sem ajustes forçados para uma faixa específica.
